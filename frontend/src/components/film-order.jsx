                    ...
                    <div className="flex f-col gap20" style={{"padding":"15px"}}>
                        <div className="flex startver cenhor gap20">
                            <div className="flex cenhor gap10">
                                ...
                                <p style={{"fontSize":"16px","color":"white"}}><b>2 giờ 29 phút</b></p>
                            </div>
                            <div className="flex cenhor gap10">
                        ...
                        <div className="flex cenhor gap10">
                            ...
                            <p style={{"fontSize":"16px","color":"white"}}>CGV Vincom Thủ Đức</p>
                        </div>
                        ...
                        <div className="flex cenhor gap10">
                            ...
                            <p style={{"fontSize":"16px","color":"white"}}><b>19h30’ - 30/9/2024</b></p>
                        </div>
                        ...
                        <div className="flex cenhor gap10">
                            ...
                            <p style={{"fontSize":"16px","color":"white"}}>2 ghế</p>
                        </div>
                     </div>
                </div>
            </div>
